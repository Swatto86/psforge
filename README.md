...
**Current version:** [1.4.47](https://github.com/Swatto86/psforge/releases/tag/v1.4.47)
...
4. **Inspect** — Terminal output below the editor; **Reference → Problems** for parser/analyzer errors (**Fix All** walks them one at a time via AI).
