...
1. Download the latest `PSForge_1.0.5_x64-setup.exe` from the [Releases page](../../releases).
...
```powershell
msiexec /i PSForge_1.0.5_x64_en-US.msi /quiet
```
...
.\update-application.ps1 -Version 1.0.5

# Preview what would happen (no changes made)
.\update-application.ps1 -Version 1.0.5 -DryRun
```
